...
const Buttons = ({ handleClear, handleEqual, handleNumber, handleOperator, operator, 
  // negaviteInput
 }) => {
  // {() => removeToDos(toDo.id)}
  ...
  return (
    <section>
      ...
      <button className="decmile" name="decmile">.</button>
      <button className="posNeg"  name="posNeg" value="&plusmn;">
        &plusmn;
      </button>
