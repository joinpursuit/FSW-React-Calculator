...
const KeyPad = ({result, handleNum, handleOperator, handleZero}) => {
    return (
        <section className="container">
            <Solution result={result}/>
            <button onClick={e => handleOperator(e.target.value)} className="child key10" value="AC">AC</button>
            ...
            <button onClick={e => handleOperator(e.target.value)} className="child key16" value="=" >=</button>
