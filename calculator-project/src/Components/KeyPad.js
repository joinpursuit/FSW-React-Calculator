...
const KeyPad = ({result, handleNum, handleOperator}) => {
    return (
        <section className="container">
            <Solution result={result}/>
            <button className="child key10" value="AC">AC</button>
            <button onClick={e => handleOperator(e.target.value)} className="child key11" value="+/-">+/-</button>
            <button className="child key12" value="÷">÷</button>
            ...
            <button className="child key13" value="x">x</button>
            ...
            <button className="child key14" value="-">-</button>
            <button className="child key15" value="+">+</button>
            ...
            <button className="child key16" value="=" >=</button>
            <button onClick={e => handleNum(e.target.value)} className="child key0" value="0">0</button>
        </section>
    )
}
