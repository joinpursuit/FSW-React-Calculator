...
class App extends React.Component {
  ...
  handleClick=(e)=>{
    ...
    switch (e.target.value) {
      ...
      case "C":
        ...
        break;
      case "DEL":
        const removeLastDigit=this.state.currenInput;
      ...
      case "+/-":
        ...
        break;
      case "%":
        if(this.state.currenInput) this.setState({
          currenInput:(Number(this.state.currenInput)/100).toString()  
        });
        else this.setState({
          currenInput:(Number(this.state.pValue)/100).toString()
        });
        break;
      case "=":
        this.handleCalculation();
        this.setState({classStatus:"hidden", isTyping:false});
  ...
  render() { 
    ...
    return (
      <div id="main">
        <div id="result">
          <div>{`Ans=${this.formatting(this.state.pValue)}`}</div>
...
class App extends React.Component {
  ...
  handleCalculation=()=>{
    ...
    switch (operator) {
      case "+":
        this.setState({
          currenInput:pValue+Number(currenInput),
      ...
      case "/":
        this.setState({
          currenInput:Math.round(pValue/Number(currenInput)),
  ...
  handleClick=(e)=>{
    ...
    switch (e.target.value) {
      ...
      case "=":
        this.handleCalculation();
        this.setState({classStatus:"hidden"});
  ...
  render() { 
    ...
    return (
      <div id="main">
        <div id="result">
          <div className={this.state.classStatus} id="previousVal" >{`${this.formatting(this.state.pValue)} ${this.state.operator}`}</div>
          <div className="currentResult">{this.state.isTyping? this.formatting(this.state.currenInput) : "0"}</div>
        </div>
        <Touches onSelectDigit={this.handleClick} touches={this.state.touches}/>
