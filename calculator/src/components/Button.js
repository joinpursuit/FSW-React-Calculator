    ...
    render() {
        return(
            <div>
                ...
                <button className="button orange" name="*" onClick={e => this.props.onClick(e.target.name)}>x</button><br/>
                ...
                <button className="button zero" name="0" onClick={e => this.props.onClick(e.target.name)}>0</button>
                <button className="button" name="." onClick={e => this.props.onClick(e.target.name)}>.</button>
                <button className="button orange" name="=" onClick={e => this.props.onClick(e.target.name)}>=</button><br/>
            </div>
        )
